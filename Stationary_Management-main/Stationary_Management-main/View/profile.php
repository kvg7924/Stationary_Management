...
<?php include("../Helpers/execution_time.php"); ?>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
        <a class="navbar-brand fw-bold" href="<?php echo (isset($_SERVER['HTTPS']) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'] . 'Stationary_Management-main\Stationary_Management-main\View\index.php'; ?>">Stationery Shop</a>
