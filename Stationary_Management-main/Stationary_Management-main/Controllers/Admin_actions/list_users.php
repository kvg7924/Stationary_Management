                ...
                <tbody>
                    ...
                    if ($row_count == 0) {
                        ...
                        while ($row_fetch_users = mysqli_fetch_array($get_user_result)) {
                            ...
                            <td>$user_email</td>
                            <td>
                                <img src='../../Helpers/images/user_images/$user_image' alt='$username photo' class='img-thumbnail' width='100px'/>
                            </td>
                            <td>$user_address</td>
                            <td>$user_mobile</td>
                            <td>
                                <a href='../../View/admin_index.php?delete_user=$user_id' data-bs-toggle='modal' data-bs-target='#deleteModal_$user_id'>
                                                ...
                                                <div class='d-flex flex-column gap-3 align-items-center text-center'>
                                                    ...
                                                    <div class='btns d-flex gap-3'>
                                                        ...
                                                        <button type='button' class='btn px-5 btn-primary' data-bs-dismiss='modal'>
                                                            <a class='text-light' href='../../View/admin_index.php?delete_payment=$user_id'>
