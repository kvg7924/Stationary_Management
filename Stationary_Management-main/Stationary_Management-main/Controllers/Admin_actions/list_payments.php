...
<head>
    ...
    <title>Stationery Payments Page</title>
</head>
                ...
                <tbody>
                    ...
                    if ($row_count == 0) {
                        ...
                        while ($row_fetch_payments = mysqli_fetch_array($get_payment_result)) {
                            ...
                            <td>$payment_date</td>
                            <td>
                                <a href='../../View/admin_index.php?delete_payment=$payment_id' data-bs-toggle='modal' data-bs-target='#deleteModal_$payment_id'>
                                                ...
                                                <div class='d-flex flex-column gap-3 align-items-center text-center'>
                                                    ...
                                                    <div class='btns d-flex gap-3'>
                                                        ...
                                                        <button type='button' class='btn px-5 btn-primary' data-bs-dismiss='modal'>
                                                            <a class='text-light' href='../../View/admin_index.php?delete_payment=$payment_id'>
