...
if(isset($_POST['user_update'])){
    ...
    move_uploaded_file($update_image_tmp,"../../Helpers/images/user_images/$update_image");
            ...
            <div class="col-md-6">
                ...
                <form action="" method="post" enctype="multipart/form-data" class="d-flex flex-column gap-3">
                    ...
                    <div class="form-outline d-flex">
                        ...
                        <img src="../../Helpers/images/user_images/<?php echo $user_image;?>" height="80px" alt="<?php echo $username;?> Photo">
                    </div>
                    <div class="form-outline">
